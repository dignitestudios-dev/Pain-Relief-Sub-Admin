...
import SkeletonLoader from "../../../components/app/SubAdminDashboard/SkeletonLoader";
  ...
  return (
    <div className="p-3 bg-white rounded-lg shadow">
      ...
      <div className="bg-[#FAFAFA] p-4 rounded-md">
        <div className="grid grid-cols-[40px_1.2fr_1fr_1.3fr_1fr_2fr_0.8fr_1fr] gap-4 px-4 py-3 rounded-md text-sm font-semibold text-black bg-[linear-gradient(234.85deg,rgba(41,171,226,0.2)_-20.45%,rgba(99,207,172,0.2)_124.53%)]">
          ...
          {loading ? (
            ...
            sortedData.map((provider, index) => {
              ...
              return (
                ...
                >
                  <div>{rowNumber}</div>{" "}
                  {/* Display the corrected row number */}
      ...
      <div className="flex items-center justify-end space-x-4 mt-6 px-4">
        ...
        <div className="text-sm text-gray-700 font-semibold">
          <span className="text-gray-700">Page {currentPage}</span> of{" "}
          {totalPages}
        </div>
