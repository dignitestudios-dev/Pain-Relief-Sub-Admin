...
import ReferredFriends from "../../../components/app/SubAdminDashboard/ReferredFriends";
      ...
      {activeTab === "Basic Info" && (
        <div className="bg-[#FAFAFA] p-6 rounded-md text-sm space-y-2">
          ...
          <InfoRow
            ...
            value={provider.addresses[0]?.address}
            multi
          />
          <span className="w-full border border-b flex"></span>
          <InfoRow
            label="Pain Relief Coach"
            value={provider.isPainReliefCoach ? "Yes" : "No"}
          />
          <span className="w-full border border-b flex"></span>
        ...
        <div className="p-6 bg-[#FAFAFA] rounded-md">
          ...
          {provider.documents && provider.documents.length > 0 ? (
            ...
            <p className="text-gray-600">
              No medical license documents uploaded.
            </p>
          )}
        </div>
      )}
