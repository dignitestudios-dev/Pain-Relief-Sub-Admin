  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow mx-auto">
      ...
      <div className="bg-[#FAFAFA] p-6 rounded-md text-sm space-y-3">
        <p className="text-[24px] font-bold pb-4 border-b border-[#EAEAEA]">Sub Admin Info</p>
      ...
      {isEditModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50" onClick={closeModal}>
          ...
          >
            ...
            <h2 className="text-xl font-bold mb-4 border-b pb-2">Edit Sub Admin Details</h2>
